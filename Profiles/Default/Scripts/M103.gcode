...
(print,Warte auf Eingang #<pvalue> mit Status #<qvalue>...  Aktueller Status #<_hw_input_num|#<pvalue>>)
...
O<chk> if [#<stoponerror> EQ 1]
	...
	(dlgname,Timeout)
	(dlg,Timeout beim warten auf Eingang #<pvalue>. Neu versuchen?, typ=label, x=0, w=410, color=0xffffff)
